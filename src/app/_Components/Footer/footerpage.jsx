...
export default function Footer() {
  ...
  <div className="bg-white border border-dashed border-gray-300 p-6 sm:p-8 text-center shadow-lg mx-3">
    ...
    <form className="flex justify-center items-center gap-2 sm:gap-0 flex-row">
      ...
      <button
        type="submit"
        className="bg-[#c58e35] text-white px-4 sm:px-6 py-2 sm:py-3 hover:bg-[#b47f2f] transition text-sm sm:text-base"
      >
        Subscribe
      </button>
    </form>
    ...
    <div>
      ...
      <div className="flex space-x-3">
        {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn].map((Icon, index) => (
          <div
            key={index}
            className="w-10 h-10 flex items-center justify-center bg-white border border-gray-200 text-[#d6a354] hover:bg-[#c58e35] hover:text-white transition cursor-pointer"
          >
            <Icon size={18} />
          </div>
        ))}
        ...
        {[1, 2].map((item) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#c58e35] text-md mt-1">24 Aug, 2022</p>
            </div>
          </div>
        ))}
      </div>
    ...
    <div className="sm:col-span-2 lg:col-span-1">
      ...
      <ul className="space-y-4 text-gray-700">
        <li className="flex items-center gap-3 border-b-2 border-dashed border-[#e6e6e6] py-3">
          <MapPin size={18} className="text-[#c58e35]" />
          220 Even Green Hamton Road, New York
        </li>
        <li className="flex items-center gap-3 border-b-2 border-dashed border-[#e6e6e6] py-3">
          <Phone size={18} className="text-[#c58e35]" /> +012 123 123 123
        </li>
        <li className="flex items-center gap-3 border-b-2 border-dashed border-[#e6e6e6] py-3">
          <Phone size={18} className="text-[#c58e35]" /> +012 123 123 123
        </li>
        <li className="flex items-center gap-3 border-b-2 border-dashed border-[#e6e6e6] py-3">
          <Mail size={18} className="text-[#c58e35]" />
  ...
  <div className="border-t border-gray-200 text-center mt-16 pt-6 text-gray-500 text-sm">
    Copyright © 2022 by{" "}
    <span className="text-[#c58e35] font-medium">wowhair</span>
  </div>
</footer>
